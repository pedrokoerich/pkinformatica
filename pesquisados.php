...
<html>
    <head>
        ...
        <!-- <script src="JS/catalogo_Produtos.js"></script> -->
        ...
        <link href="CSS/pesquisados.css" rel="stylesheet">
    </head>
            ...
            <main class="corpo_catalogo">
                <div class="row2">
                    ...
                    <form method="GET" action="pesquisados.php" class="col-lg-12 col-md-12 col-sm-12 col-12 pesquisa">
                        <input placeholder="Pesquise por um produto" type="text" name="nPesquisar">
                        <button type="submit">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 catalogo">
                    <?php
                        $pag = (isset($_GET['pag'])) ? $_GET['pag'] : 1;
                        include "php/pesquisa.php";
                        $produto = $_GET['nPesquisar'];
                    ?>
                </div>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li>
                                <?php
                                    if($pag_anterior != 0){ ?>
                                        <li class="page-item"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=1"><<</a></li>
                                        <li class="page-item"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=<?php echo $pag_anterior;?>"><</a></li>
                                <?php }else{ ?>
                                    <li class="page-item disabled"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=1"><<</a></li>
                                    <li class="page-item disabled"><a class="page-link"><</a></li>
                                <?php } ?>        
                            </li>
                            <li class="page-item"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=<?php echo $pag;?>"><?php echo $pag;?></a></li>
                            <li>
                                <?php
                                    if($pag_posterior <= $num_pg){ ?>
                                        <li class="page-item"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=<?php echo $pag_posterior;?>">></a></li>
                                        <li class="page-item"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=<?php echo $num_pg;?>">>></a></li>
                                <?php }else{ ?>
                                        <li class="page-item disabled"><a class="page-link">></a></li>
                                        <li class="page-item disabled"><a class="page-link" href="pesquisados.php?nPesquisar=<?php echo $produto;?>&pag=<?php echo $num_pg;?>">>></a></li>
                                <?php } ?>        
                            </li>
                        </ul>
                    </nav>
