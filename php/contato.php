<?php
    ...
    $email              = utf8_encode($_POST['nEmail_contato']);        //Email do Usuário
	...
	$mail->Subject = "Contato - PK Informatica";                        //Assunto do email

    //Estrutura do corpo do E-mail
    $conteudo_email = "Você recebeu uma mensagem de <b>$nome</b> ($email):   
                        <br><br>  
                        <b>Mensagem:</b>
                        <br> 
                        $mensagem 
