<?php
    ...
    $listaProdutos = "SELECT * FROM produtos";
    $lista = mysqli_query($conn, $listaProdutos);
    $produtosListados = mysqli_num_rows($lista);            //Número de resultado encontrados
    ...
    if($produtosListados > 0){ //Verifica se há registros no banco
        ...
        //SELECT com limitação de resultados por página
    
        $listaProdutos = "SELECT * FROM produtos LIMIT $inicio, $qtd_pg";
        $lista = mysqli_query($conn, $listaProdutos);
                        ...
                        <div class='modal-dialog' role='document'>
                            <div class='modal-content'>
                                ...
                                <div class='modal-footer'>
                                    ...
                                    <a href='php/excluiProduto.php?id=$id'><button type='button' class='btn btn-danger'>Excluir Produto</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
