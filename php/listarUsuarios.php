<?php
    ...
    $usuariosListados = mysqli_num_rows($lista);            //Linhas com resultados encontrados
    ...
    if($usuariosListados > 0){ //Verifica se há registros no banco
        ...
        //SELECT com limitação de resultado por página
        $listaUsuarios = "SELECT * FROM usuarios LIMIT $inicio, $qtd_pg";
        $lista = mysqli_query($conn, $listaUsuarios);
                            ...
                            <div class='modal-dialog' role='document'>
                                <div class='modal-content'>
                                    ...
                                    <div class='modal-footer'>
                                        ...
                                        <a href='php/excluiUsuario.php?id=$id'><button type='button' class='btn btn-danger'>Excluir Usuário</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
